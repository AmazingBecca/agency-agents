...
GLOBALS_SETITEM_REBIND = PREFIX + r'''
def _rebind():
    globals().__setitem__("_Mutator", _replacement)
...
SETATTR_MODULE_REBIND = PREFIX + r'''
def _rebind():
    setattr(sys.modules[__name__], "_Mutator", _replacement)
