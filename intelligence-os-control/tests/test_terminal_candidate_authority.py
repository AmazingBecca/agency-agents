...
class TerminalCandidateAuthorityTests(unittest.TestCase):
    ...
    def test_terminal_gate_closes_nested_result_state_gap_left_by_authenticated_base(self) -> None:
        ...
        self.assertEqual(terminal_report["nested_dispatch_case_count"], 5)
        self.assertEqual(terminal_report["terminal_total_case_count"], 24)
        self.assertEqual(
    ...
    def test_terminal_gate_accepts_runner_that_rejects_nested_dispatch_attacks(self) -> None:
        ...
        self.assertEqual(report["nested_dispatch_case_count"], 5)
        self.assertEqual(report["terminal_total_case_count"], 24)
