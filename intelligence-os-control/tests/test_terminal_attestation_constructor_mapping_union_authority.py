...
class TerminalAttestationConstructorMappingUnionAuthorityTests(unittest.TestCase):
    ...
    def test_inline_mapping_union_cannot_launder_constructor_authority(self) -> None:
        self._assert_rejected(INLINE_UNION_ATTACK)

    def test_aliased_mapping_union_cannot_launder_constructor_authority(self) -> None:
        self._assert_rejected(ALIASED_UNION_ATTACK)
