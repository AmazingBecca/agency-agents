...
BRANCH_REBIND_ATTACK = PREFIX + r"""
if True:
    _Mutator = _replacement
""" + SUFFIX


TUPLE_REBIND_ATTACK = PREFIX + r"""
(_Mutator,) = (_replacement,)
""" + SUFFIX


TRY_REBIND_ATTACK = PREFIX + r"""
try:
    _Mutator = _replacement
except Exception:
    pass
...
class TerminalAttestationDecoratedClassModuleRebindTests(unittest.TestCase):
    ...
    def test_branch_scoped_module_rebind_cannot_replace_reviewed_class(self) -> None:
        self._assert_rejected(BRANCH_REBIND_ATTACK)

    def test_tuple_module_rebind_cannot_replace_reviewed_class(self) -> None:
        self._assert_rejected(TUPLE_REBIND_ATTACK)

    def test_try_scoped_module_rebind_cannot_replace_reviewed_class(self) -> None:
        self._assert_rejected(TRY_REBIND_ATTACK)
