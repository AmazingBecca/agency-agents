...
class TerminalAttestationConstructorKeywordAuthorityTests(unittest.TestCase):
    ...
    def test_keyword_only_constructor_field_cannot_launder_helper_authority(self) -> None:
        report = self._verify(KEYWORD_ATTACK)
