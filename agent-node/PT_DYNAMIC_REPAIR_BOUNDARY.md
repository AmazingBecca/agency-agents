...
Required repair: map the complete PT_DYNAMIC virtual range through a unique PT_LOAD segment and fail closed if the advertised PT_DYNAMIC file offset disagrees with that loaded mapping. This record is evidence only and grants no promotion, deployment, or completion authority.
